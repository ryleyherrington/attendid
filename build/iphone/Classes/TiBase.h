...
// in simulator we redefine to format for Attendid Developer console
...
{\
	NSString * exceptionName = [@"org.attendid." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.attendid";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIAttendidNativeItemNone = -1, 
	UIAttendidNativeItemSpinner = -2,
	UIAttendidNativeItemProgressBar = -3,
	
	UIAttendidNativeItemSlider = -4,
	UIAttendidNativeItemSwitch = -5,
	UIAttendidNativeItemMultiButton = -6,
	UIAttendidNativeItemSegmented = -7,
	
	UIAttendidNativeItemTextView = -8,
	UIAttendidNativeItemTextField = -9,
	UIAttendidNativeItemSearchBar = -10,
	
	UIAttendidNativeItemPicker = -11,
	UIAttendidNativeItemDatePicker = -12,
	
	UIAttendidNativeItemInfoLight = -13,
	UIAttendidNativeItemInfoDark = -14,
	
	UIAttendidNativeItemDisclosure = -15,
	
	UIAttendidNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Attendid instances of

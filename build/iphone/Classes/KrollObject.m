 ...
 * Copyright (c) 2009-2011 by Attendid, Inc. All Rights Reserved.
...
//@interface AttendidObject : NSObject
//@end

@interface AttendidObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[AttendidObject class]])
		{
			for (NSString *key in [[(AttendidObject*)o modules] allKeys])
			{
